...
# source: utils/data/sentencepiece_model.proto
...
TrainerSpec = _reflection.GeneratedProtocolMessageType('TrainerSpec', (_message.Message,), {
  ...
  '__module__' : 'data_tools.sentencepiece_model_pb2'
